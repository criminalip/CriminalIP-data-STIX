...
from Enterprise_products_cases import AllProductCases
from Enterprise_certificate_cases import CertificateCases
from Enterprise_relationship_cases import Relate
from Enterprise_malware_cases import MalwareInfoCase
...
class CourseOfActionCases:
    ...
    def vulnability_exiting(self,port_num, product, product_version, protocol, technologies, banner, sdn_name, tags_string, vulnerability_data,vuln_exit_check):
        vuln_list = [vuln for vuln in vulnerability_data if vuln['open_port_no'][0]['port'] == port_num]
